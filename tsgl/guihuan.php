...
<body>
    ...
    <div class="content">
        ...
        <form class="h" action="hs.php" method="post" enctype="multipart/form-data">
            <center>
                <hr>
                <h2>归还人信息</h2>
                用&nbsp;户&nbsp;名：<input type="text" name="user" placeholder="请使用账号来填写"><br>
                归还数量：<input type="text" name="num"><br>
                借书时间：<input type="text" name="jtime"><br>
                还书时间：<input type="text" name="htime"><br>
                ...
                <input type="submit" class="but" value="完成归还">
                <hr>
