...
<body>
    ...
    <div class="content">
        ...
        <form class="log" action="get.php" method="post" enctype="multipart/form-data">
            <h2>注&nbsp;册</h2>
            <div class="line"></div>
            姓&nbsp;&nbsp;&nbsp;名&nbsp;：<input type="text" name="xm"><br>
            用&nbsp;户&nbsp;名：<input type="text" name="zhanghao"><br>
            密&nbsp;&nbsp;&nbsp;码&nbsp;：<input type="password" name="mima"><br>
            确认密码：<input type="password" name="mima2"><br>
            <input type="submit" class="but" value="注册" name="tj">
        </form>
